                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item me-3 dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li>
                                    <a class="dropdown-item" href="/programari/tip-afisare/saptamanal">
                                        <i class="fa-solid fa-clock me-1"></i>Calendar
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="/programari/tip-afisare/administrare">
                                        <i class="fa-solid fa-clock me-1"></i>Administrare
                                    </a>
                                </li>
                            </ul>
                        </li>
