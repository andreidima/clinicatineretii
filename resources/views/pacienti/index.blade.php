            ...
            <div class="col-lg-6">
                <form class="needs-validation" novalidate method="GET" action="{{ url()->current() }}">
                    ...
                    <div class="row mb-1 custom-search-form justify-content-center">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control rounded-3" id="searchCnp" name="searchCnp" placeholder="Cnp" value="{{ $searchCnp }}">
                        </div>
                    </div>
                ...
                <table class="table table-striped table-hover">
                    <thead class="">
                        <tr class="" style="padding:2rem">
                            ...
                            <th class="text-white culoare2">Data nașterii</th>
                    ...
                    <tbody>
                        @forelse ($pacienti as $pacient)
                            <tr>
                                ...
                                <td class="">
                                    {{-- {{ $pacient->telefon_fix }}
                                    {!! $pacient->telefon_fix && $pacient->telefon_mobil ? '<br>' : '' !!}
                                    {{ $pacient->telefon_mobil }} --}}
                                    {{ $pacient->telefon }}
                                </td>
                                <td class="">
